...
For crawler and data-source tasks, derive selectors, fields, pagination, namespaces, and URL handling from actual source evidence. Preserve only APIs and command-line arguments explicitly required by the task or repository tests. Do not assume a familiar site schema, fixed selector, output filename, parser function, or historical field set.
